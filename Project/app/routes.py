...
#////////////////////edit delete add//////////////////////////////////////////////
    ...
    def return_small_storage(small_storage_id):
     ...
     if quantity > small_storage.quantity:
        flash('Quantity to return exceeds available quantity.', 'error')
        return redirect(url_for('create_small_storage'))
     ...
     try:
        # Update balances
        partner.balance -= quantity
        small_storage.quantity += quantity  # Update small storage quantity
